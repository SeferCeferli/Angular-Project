...
namespace Student.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<StudentAdminContext>(options => options.UseSqlServer(Configuration.GetConnectionString("StudentAdminPortalsDb")));
            services.AddScoped<IStudentRepositories, SqlStudentRepository>();
